  ...
  return (
    <div className="pt-32 pb-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-32 grid md:grid-cols-2 gap-12 border-t border-neutral-100 pt-20">
          <div>
            <h2 className="text-3xl font-bold mb-4 tracking-tight text-black">Transparent AI</h2>
          ...
          <div>
            <h2 className="text-3xl font-bold mb-4 tracking-tight text-black">Enterprise Grade</h2>
            <p className="text-neutral-500 leading-relaxed font-medium">
